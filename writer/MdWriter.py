...
def __create_response_properties_table(properties: list[Attribute]) -> str:
    ...
    table = table_template.format(col1=property_header, col2=description_header, col3=type_header, col4=required_header,
                                  col5=example_header)
    table += table_template.format(col1="-" * property_header_column_width, col2="-" * description_header_column_width,
                                   col3="-" * type_header_column_width, col4="-" * required_header_column_width,
                                   col5="-" * example_header_column_width)
    table += table_body
    return table
